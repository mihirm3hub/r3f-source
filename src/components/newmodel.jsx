      ...
      {ishotspotVisible && (
        <mesh
          ...
          onClick={() => (
            ...
            document.getElementById('dropdown-content').style.display = 'none',
            document.getElementById('streetview').src = './images/StreetView-1.png',
      ...
      {ishotspotVisible && (
        <mesh
          ...
          onClick={() => (
            ...
            document.getElementById('dropdown-content').style.display = 'none',
            document.getElementById('streetview').style.display = 'block',
            document.getElementById('streetview').src = './images/StreetView-2.png',
            helpBtn.style.display='none',
            streetviewUI = true,
            isOpen = true,
            picno = 2
      ...
      {ishotspotVisible && (
        <mesh
          ...
          onClick={() => (
            ...
            document.getElementById('dropdown-content').style.display = 'none',
            document.getElementById('streetview').style.display = 'block',
            document.getElementById('streetview').src = './images/StreetView-3.png',
            helpBtn.style.display='none',
            streetviewUI = true,
            isOpen = true,
            picno = 3
